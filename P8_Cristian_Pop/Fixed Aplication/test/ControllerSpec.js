...
describe('controller', function () {
	...
	describe('toggle all', function () {
		...
		it('should toggle all todos to completed', function () {
			// TODO: write test
			//spy on model to have been called with id, completed, true and function
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			// TODO: write test
				// set up model todo list, set view to default, trigger itemRemove, 
				// check if model remove has been called with id and function
				var todos = [{ title: 'todo 1', id: 42, completed: true }, { title: 'todo 2', id: 43, completed: false }]
				setUpModel(todos)
				subject.setView('')
